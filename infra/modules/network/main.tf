...
resource "aws_route" "private_nat" {
  ...
  destination_cidr_block = "0.0.0.0/0"
  nat_gateway_id         = aws_nat_gateway.this[min(local.private_subnets[each.key].index, var.nat_gateway_count - 1)].id
}
...
resource "aws_vpc_security_group_egress_rule" "alb_all" {
  ...
  cidr_ipv4         = "0.0.0.0/0"
  ip_protocol       = "-1"
  description       = "Outbound internet access for ALB."
}
...
resource "aws_vpc_security_group_egress_rule" "ecs_all" {
  ...
  cidr_ipv4         = "0.0.0.0/0"
  ip_protocol       = "-1"
  description       = "Outbound access for ECS tasks, including package/image access via NAT."
}
...
resource "aws_vpc_security_group_egress_rule" "rds_all" {
  ...
  cidr_ipv4         = "0.0.0.0/0"
  ip_protocol       = "-1"
  description       = "Default outbound rule. Inbound remains restricted to ECS."
}
